%% build_george_ems_v2.m — GeorgeEMS_Champion: demand-parity edition.
...
ab('simulink/Discontinuities/Relay', 'T hyst', 'OnSwitchValue', '25', ...
   'OffSwitchValue', '5', 'OnOutputValue', '1', 'OffOutputValue', '0');
ab('simulink/Logic and Bit Operations/Compare To Constant', 'spd ok', ...
   'relop', '>', 'const', '2.0');
ab('simulink/Signal Attributes/Data Type Conversion', 'spd ok dbl', ...
   'OutDataTypeStr', 'double');
ab('simulink/Math Operations/Product', 'gate ctl');
...
L('gate slew/1', 'T rear raw/1');      L('regen ramp/1','T rear raw/2');
